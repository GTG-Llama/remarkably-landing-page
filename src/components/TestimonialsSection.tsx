      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="relative max-w-8xl mx-auto">
          <div className="relative">
            ...
            <div className="border-4 border-black bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] p-8 md:p-12 overflow-hidden relative z-0 min-h-[980px] md:min-h-[650px] lg:min-h-[450px]">
