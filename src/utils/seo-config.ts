...
export const seoConfigs: Record<string, SEOConfig> = {
  home: {
    ...
    keywords: [
      ...
      'AI grading software for schools',
      'automated essay feedback tool',
      'digital essay marking system',
      'handwritten text recognition grading',
      'bulk essay grading platform',
      'teacher workload reduction tool',
      'intelligent essay assessment',
      'AI-powered rubric grading',
      'educational AI for teachers',
      'smart grading technology',
      'essay grading time saver',
      'automated student feedback system',
      'AI essay evaluation platform',
      'machine learning essay grading',
      'teacher efficiency software',
      'educational assessment AI',
      'automated writing assessment',
      'AI teaching tools Singapore',
      'essay grading burnout solution',
