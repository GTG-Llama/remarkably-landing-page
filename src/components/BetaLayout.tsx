...
const BetaLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const navItems = [
    { 
      ...
      path: '#',
      dropdown: [
        { name: 'Features', path: '/beta/features' },
        { name: 'Demo', path: '/beta/demo' },
      ]
    },
    { 
      name: 'Solutions', 
      path: '#',
      dropdown: [
        { name: 'Benefits', path: '/beta/benefits' },
        { name: 'Use Cases', path: '/beta/about-us' },
      ]
    },
    { 
      name: 'Resources', 
      path: '#',
      dropdown: [
        { name: 'About Us', path: '/beta/about-us' },
        { name: 'Q&A', path: '/beta/qna' },
        { name: 'Testimonials', path: '/beta/testimonials' },
        { name: 'Achievements', path: '/beta/achievements' },
        { name: 'Rubric Guide', path: '/beta/rubric-guide' },
        { name: 'Stress Reduction', path: '/beta/stress-reduction' },
        { name: 'Case Study', path: '/beta/case-study' },
      ]
    },
    { name: 'Pricing', path: '/beta/pricing' },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50/30 via-indigo-50/20 to-purple-50/30">
      ...
      {/* Mobile Header - Use the new BetaHeader component */}
