...
const EssayFocusSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <ArrowDown size={24} className="text-black mx-auto animate-bounce justify-center" />
        <span className="text-sm font-bold mt-2 block text-black text-center">Continue scrolling</span>
      </motion.div>
    </section>
  );
};
