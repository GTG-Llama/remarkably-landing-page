  ...
  return (
    ...
    >
      ...
      <div className="content-container z-10 text-center px-4 md:px-8 max-w-5xl mx-auto hero-anim">
        <h1
          ref={headingRef}
          className="font-playfair text-9xl md:text-[12rem] lg:text-[14rem] font-extrabold tracking-tight relative bg-clip-text text-transparent bg-gradient-to-b from-black via-black to-remarkably-gold/90"
        >
          remarkably.
        </h1>
      </div>
