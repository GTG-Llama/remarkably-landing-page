...
const EssayFocusSection: React.FC = () => {
  ...
  return <section ref={sectionRef} id="essay-focus" className="min-h-screen flex items-start justify-center relative overflow-hidden py-20 bg-white">
      <div className="absolute inset-0 bg-white"></div>
      
      <div className="content-container w-full text-center md:px-8 max-w-6xl mx-auto z-10 relative">
        <motion.div className="mb-16 bg-white rounded-md border-4 border-black p-8 md:p-12 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]" initial="hidden" whileInView="visible" viewport={{
        once: true,
        amount: 0.3
      }} variants={contentVariants}>
          <motion.h2 ref={titleRef} className="text-3xl md:text-5xl font-black mb-6 text-black" variants={contentVariants}>
            See How Remarkably Works
          </motion.h2>
          
          <motion.p ref={descriptionRef} className="text-xl text-gray-800 mb-10 max-w-3xl mx-auto" variants={contentVariants}>
            Our AI-powered technology analyzes essays in real-time, providing personalized
            feedback with the accuracy and nuance of an experienced educator.
          </motion.p>
        </motion.div>
          ...
          amount: 0.6
              ...
              <div className="w-full lg:w-1/2 bg-[#c8ee46] p-8 lg:p-12 flex flex-col justify-center border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative z-10 transform transition-transform hover:-translate-y-1 hover:-translate-x-1 hover:shadow-[10px_10px_0px_0px_rgba(0,0,0,1)]">
                <div className="flex flex-col text-left">
                  ...
                  <h3 className="text-2xl lg:text-3xl font-black mb-6 text-black">{card.title}</h3>
                  <p className="text-gray-800 text-lg mb-6">{card.description}</p>
              ...
              <div className="w-full lg:w-1/2 bg-white border-4 border-black p-6 flex items-center justify-center lg:ml-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative z-0 transform transition-transform hover:-translate-y-1 hover:-translate-x-1 hover:shadow-[10px_10px_0px_0px_rgba(0,0,0,1)]">
                <div className="w-full max-w-lg overflow-hidden">
                  ...
                  <div className="aspect-video bg-gray-100 flex items-center justify-center border-2 border-black">
                    <img src={`/thumbnails/${card.step}-thumbnail.jpg`} alt={card.title} className="w-full h-full object-cover" />
                  </div>
                </div>
              </div>
            </motion.div>)}
